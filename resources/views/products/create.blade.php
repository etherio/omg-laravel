    ...
    <div class="max-w-2xl mx-auto mt-8 p-5 overflow-x-auto bg-white shadow-md border-gray-20">
        <form method="POST" action="{{ route('products.store') }}">
            ...
            <div class="min-w-full p-2">
                ...
                <x-input id="images" class="block mt-1 w-full" type="text" name="images" :value="old('images')" />
            </div>
            ...
            <div class="flex justify-between">
                ...
                <div class="w-4/12 inline-block p-2">
                    ...
                    <x-input id="size" class="block mt-1 w-full" type="number" name="size" />
                </div>
            </div>
            ...
            <div class="flex justify-between">
                <div class="w-6/12 inline-block p-2">
                    ...
                    <x-input id="min_age" class="block mt-1 w-full" type="number" name="min_age" />
                </div>

                <div class="w-6/12 inline-block p-2">
                    <x-label for="max_age" :value="__('Maximum Age')" />
                    <x-input id="max_age" class="block mt-1 w-full" type="number" name="max_age" />
                </div>
            </div>
